          ...
          <div className="relative overflow-hidden rounded-lg border border-[var(--crema-50)]/12 bg-[var(--espresso-800)] px-6 pt-[22px] pb-[26px] shadow-2 max-[560px]:px-4 max-[560px]:pt-[18px] max-[560px]:pb-[22px]">
            ...
            <div className="relative z-[1] grid grid-cols-[1fr_auto_1fr] items-center gap-[14px] max-[560px]:gap-[6px]">
              ...
              <div className="flex flex-col items-center gap-[9px]">
                <div className="relative whitespace-nowrap font-mono text-[56px] font-semibold leading-none tracking-[-0.02em] text-[var(--marigold-300)] [font-feature-settings:'tnum','zero'] max-[560px]:text-[40px]">
            ...
            <div className="relative z-[1] mt-[22px] flex items-center justify-between gap-4 border-t border-[var(--crema-50)]/10 pt-[18px] max-[560px]:flex-col max-[560px]:items-start max-[560px]:gap-[14px]">
              <span className="min-h-[1.4em] pl-10 font-serif text-[15px] italic text-[var(--crema-200)] max-[560px]:pl-14">
  ...
  return (
    <div className="flex min-w-0 flex-col items-center gap-[11px] text-center">
      <motion.div
        ...
        className={cn(
          "flex size-[86px] shrink-0 items-center justify-center rounded-full border-[3px] bg-[var(--espresso-700)] transition-colors max-[560px]:size-16",
...
function JudgeDot({ pick, on, reduce }: { pick: "l" | "r"; on: boolean; reduce: boolean | null }) {
  ...
  const emptyClass = "border-[var(--crema-50)]/20 bg-transparent";
  return (
    <motion.span
