...
- [x] Storage module + URL param helpers
...
- [x] Brew route + URL params + autostart/ready state + session reset
...
- [x] Calculator URL pre-fill + home last-brew card + saved-recipes entry
...
- [x] Saved recipe card redesign (variant A: spec-led + chips, identity dedup, trash icon; mobile-first)
